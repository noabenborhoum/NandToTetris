public class Code {
    ...
    public static String comp(String comp) {
        if(comp.equals("0")){
            ...
            throw new Error(String.format("Error", comp));
        }
    }
    ...
    //Returns the dest represntion in binary code.
    public static String getDest(String Value){
        return dest(Value);
    }

    //Returns the comp represntion in binary code.
    public static String getComp(String Value){
        return comp(Value);
    }

    //Returns the jump represntion in binary code.
